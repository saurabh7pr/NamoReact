...
const fetchData =  async() => {
   const data = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=19.952181&lng=73.862673&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
